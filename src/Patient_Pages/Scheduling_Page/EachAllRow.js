   ...
   const LightTooltip = styled(({ className, ...props }) => (
    ...
    <div className="table_tr each_Table" id="each_Table">
        ...
        <div className="header3" style={{borderBottom:"1px solid #DCE3EC"}}>
            <span className="header_span" style={{textAlign:"center",fontSize:".9rem"}}>{props.child_fname+" "+props.child_lname}</span>
        </div>
        <div className="header4" style={{borderBottom:"1px solid #DCE3EC"}}>
            <span className="header_span" style={{textAlign:"center",fontSize:".9rem"}}>{props.child_vaccineName}</span>
        </div>
