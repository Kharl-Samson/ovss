...
export default function ViewAllSchedulePage(){
    ...
    function gotoMakeSchedule(){
      navigate(`/Make_Schedule`);
    }
  ...
  document.title = "OVSS | View Schedule";
        ...
        <div className="admin_main_content">
            <div className="container">
                ...
                <div className='breadcrumbs_patient_profile'>
                  <p style={{color:"#4D77FF"}}>View Schedule</p>
                  <p style={{color:"#4D77FF"}}>&#62;</p>
                  <p style={{color:"#666f75"}} onClick={gotoMakeSchedule}>Schedule</p>
                </div>
                ...
                <div className="header_table">
                  ...
                  <div className="header3">
                      <span className="header_span" style={{fontWeight:"700",textAlign:"center"}}>CHILD NAME</span>
                  </div>
                  <div className="header4">
                      <span className="header_span" style={{fontWeight:"700",textAlign:"center"}}>VACCINE</span>
                  </div>
