...
import Schedule_History_Report from '../../../Reports_Pages/ScheduleHistoryReport';
...
export default function Admin_History_Schedule_Page(){
  ...
  setTimeout(function () {
    ...
    document.getElementById("admin_history_schedule_link").style.backgroundColor = "#e7e7ff";
    document.getElementById("left_nav_history_sched_border").style.borderLeft = "5px solid #4D77FF";
...
function search_Schedule(){
  ...
  function printDocument() {
    ...
    for (let i = 1;i  <= len; i++){
      html2canvas(document.querySelector('#history_report_container'), {
        useCORS: true,
        allowTaint: true,
        scrollY: 0,
      }).then((canvas) => {
